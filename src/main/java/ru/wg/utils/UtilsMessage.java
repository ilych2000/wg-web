...
public class UtilsMessage {
    ...
    public static final Logger LOG = Logger
            .getLogger(UtilsMessage.class);




    /**
     * Возвращает Map полей объекта с родителями, кроме статических и
     * <b>transient</b>.
     * 
     * @param object
     * @param startClass
    ...
    public static Map<String, Object> toParametersMap(Object object,
            Class<?> startClass, Class<?> stopClass,
            MessageUtils.ObjectFieldNamingStrategy namingFieldStrategy) {
        ...
        if (namingFieldStrategy == null) {
            namingFieldStrategy =
                    MessageUtils.OBJECT_FIELD_NAMING_STRATEGY_DEFAULT;
        }

        Field[] fields =
                ReflectionUtils.getAllClassFieldsToClass(startClass, stopClass);
            ...
            if (!Modifier.isStatic(field.getModifiers())
                ...
                try {
                    ...
                    if (o != null && o instanceof Date) {
                        o =
                                DateUtils.getDateFormatString((Date) o,
                    ...
                    LOG.error("toParametersMap field name '" + name
                            + "' set to '" + o + "'", e);
                }
            }
        }
