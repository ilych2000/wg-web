...
public class DateUtils {
    ...
    static {
        try {
            ...
            LOG.error("DATA_TYPE_FACTORY_INSTANCE = DatatypeFactory.newInstance()", e);
        }
    }
    ...
    public static final String DATE_FORMAT_DEFAULT = DATE_FORMAT_DATE + " " + DATE_FORMAT_TIME;
    ...
    /** Поле класса */
    private static final ThreadLocal<SimpleDateFormat> PATERN_DATE_FORMAT_DEFAULT =
    ...
    public static String getIntervalDateString(long intervalMSec) {
        ...
        formatValueDate = ((mm > 9) ? "" : "0") + mm + ":" + ((ss > 9) ? "" : "0") + ss;

        if (btw != 0) {
            long hh = btw % 24;
            btw = btw / 24;
            formatValueDate = ((hh > 9) ? "" : "0") + hh + ":" + formatValueDate;
     ...
     * Метод
     */
    public static String getDateReFormatString(String date, String format1, String format2)
     ...
     * Метод
     */
    public static Date getDateFormatString(String sDate, String format) throws ParseException {
        ...
        try {
            ...
            LOG.error("DateUtils.getDateFormatString dateFormat.parse('" + sDate + "' : '" + format
                    + "')", e);
            throw new ParseException("DateUtils.getDateFormatString dateFormat.parse(" + sDate
                    + " : " + format + "). " + e.getMessage(), e.getErrorOffset());
        }
    }
     ...
     * </p>
     * <p>
     * The parsing is done field by field so that the following holds for any lexically correct
     * String x:
     * </p>
     *
     * <pre>
     ...
     * </pre>
     * <p>
     * Except for the noted lexical/canonical representation mismatches listed in
     * <a href="http://www.w3.org/2001/05/xmlschema-errata#e2-45"> XML Schema 1.0 errata, Section
     * 3.2.7.2</a>.
     * </p>
     *
     * @param sDate
    ...
    public static Date getDateFomXMLGregorianCalendarString(String sDate)
            throws DatatypeConfigurationException {
        XMLGregorianCalendar ret = DATA_TYPE_FACTORY_INSTANCE.newXMLGregorianCalendar(sDate);
     ...
     *
     * @param aDate {@link Date}
     * @param aWithTimeZone учитывать временную зону
     * @return {@link XMLGregorianCalendar}
     * @throws DatatypeConfigurationException
     */
    public static XMLGregorianCalendar getXMLGregorianCalendar(Date aDate, boolean aWithTimeZone)
            throws DatatypeConfigurationException {
        if (aDate == null) {
            return null;
        }
        ...
        XMLGregorianCalendar ret = DATA_TYPE_FACTORY_INSTANCE.newXMLGregorianCalendar(c);
    ...
    /**
     * Получение {@link XMLGregorianCalendar} без временной зоны из строкового представления даты в
     * XML формате
     *
     * @param aXmlDateString строковое представление даты в XML формате
     * @return {@link XMLGregorianCalendar}
     * @throws DatatypeConfigurationException
     */
    public static XMLGregorianCalendar getXMLGregorianCalendarByString(String aXmlDateString)
            throws DatatypeConfigurationException {
    ...
    /**
     * Получение {@link XMLGregorianCalendar} из строкового представления даты в XML формате
     *
     * @param aXmlDateString строковое представление даты в XML формате
     * @param aWithTimeZone учитывать временную зону
     * @return {@link XMLGregorianCalendar}
    ...
    public static XMLGregorianCalendar getXMLGregorianCalendarByString(String aXmlDateString,
        ...
        XMLGregorianCalendar ret =
                DATA_TYPE_FACTORY_INSTANCE.newXMLGregorianCalendar(aXmlDateString);
    ...
    /**
     * Получение {@link XMLGregorianCalendar} из строкового представления даты и шаблона даты
     *
     * @param aDateString строковое представление даты
     * @param aPatern шаблон даты. Если <b>null</b> то будет использоваться формат
     *            {@value #DATE_FORMAT_DEFAULT}
     * @param aWithTimeZone указывать временную зону
     * @return {@link XMLGregorianCalendar}
     * @throws DatatypeConfigurationException
     * @throws ParseException
     */
    public static XMLGregorianCalendar getXMLGregorianCalendarByDateString(String aDateString,
            String aPatern, boolean aWithTimeZone) throws ParseException {
    ...
    public static String getDateFormatString(long msec, SimpleDateFormat dateFormat) {
