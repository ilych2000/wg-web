...
public class AjaxCalculateContextController extends AbstractAjaxController {
	...
	private static final Logger LOG = Logger
			.getLogger(AjaxCalculateContextController.class);
	...
	public Object doPostAjaxOperation(Object inObject,
		...
		final Integer calcID = Integer.valueOf(String.valueOf(parameters
				.get("ID")));

		CalcContext ret = new CalcContext(
				_sqlManager.getCriteriaListByCalculateID(calcID),
	...
	public static class CalcContext {
		...
		public CalcContext(List<CalculationCriteria> cRITERIAS,
				List<Scenarios> sCENARIOS,
				Map<String, Integer> sCENARIOS_CRITERIA,
				List<ScenarioGroup> sCENARIOS_GROUP) {
			super();
			CRITERIAS = cRITERIAS;
			SCENARIOS = sCENARIOS;
