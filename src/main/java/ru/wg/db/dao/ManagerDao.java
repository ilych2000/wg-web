...
public interface ManagerDao {
	...
	/**
	 * Получить список расчетов по идентификатору объекта. Если идентификатор
	 * <code>null</code>, то возвращается полный список.
	 * 
	 * @param aID
	 ...
	 * @throws Exception
	 */
	public abstract void setCalculationScenariosIdsCheck(Integer calcID,
			Integer scenarioID, Integer check) throws Exception;
	 ...
	 *            идентификатор объекта
	 * @param aEnable
	 *            получить только выбранные записи расчета
	...
	/**
	 * Установить доступность записи в расчетной таблице по идентификатору
	 * объекта
	 * 
	 * @param aID
	 *            идентификатор объекта
	 ...
	 * 
	 * @param calculateTable
	 *            таблица с данными
	 * @throws Exception
	 */
	public void updateCalculateTableID(List<CalculationTable> calculateTable)
			throws Exception;
}
